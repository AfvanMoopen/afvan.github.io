...
window.addEventListener("scroll", function (event) {
    ...
    if(scroll<skillsRect.top-bodyRect.top && headerWelcome.innerText!=='Hello, I am AfvanMJ'){
        headerWelcome.innerText='Hello, I am AfvanMJ';
    ...
    } else if(scroll>=sneakPeekRect.bottom-bodyRect.top-window.innerHeight*2 && headerWelcome.innerText!=='Cheers, AfvanMJ') {
        headerWelcome.innerText='Cheers, AfvanMJ';
    }
